...
mosaic_macros::style! {
    ...
    pub(crate) #mechanic.panel
        fill:shell radius:radius.panel
        stroke:(width:border.hairline color:shell-edge)

    pub(crate) #mechanic.elevated
        radius:radius.elevated shadow:panel-shadow

    pub(crate) #mechanic.badge
        height:26px align:center justify:center radius:radius.badge
    ...
    pub(crate) #mechanic.action
        align:center justify:center radius:radius.action fill:control.rest
    ...
    pub(crate) #mechanic.field
        height:control-size.compact-height radius:radius.field fill:chip.fill
        stroke:(width:border.hairline color:chip.edge)
    ...
    pub(crate) #mechanic.chip
        radius:radius.chip fill:chip.fill
        stroke:(width:border.hairline color:chip.edge)

    pub(crate) #mechanic.list-row
        radius:radius.action fill:picker.row
    ...
    pub(crate) #mechanic.pause-sheet
        fill:picker.sheet radius:radius.elevated shadow:modal-shadow
        stroke:(width:border.hairline color:picker.edge)

    pub(crate) #mechanic.pause-confirm
        fill:picker.danger radius:radius.panel
        stroke:(width:border.hairline color:accent.danger)

    pub(crate) #mechanic.pause-slider {
        track height:6px radius:3px fill:dial.track
        fill radius:3px fill:accent.speed
        thumb width:18px height:18px radius:9px fill:ink.fg
