...
define_lock_ranks! {
    ...
    rank DEVICE_SNATCHABLE_LOCK "Device::snatchable_lock" followed by {
        DEVICE_COMMAND_INDICES, QUEUE_LIFE_TRACKER, QUEUE_PENDING_WRITES, DEVICE_TRACKERS, DEVICE_DEFERRED_DESTROY,
        SHARED_TRACKER_INDEX_ALLOCATOR_INNER,
        DEVICE_TRACE,
        BUFFER_MAP_STATE,
    ...
    rank DEVICE_COMMAND_INDICES "Device::command_indices" followed by { QUEUE_PENDING_WRITES, QUEUE_LIFE_TRACKER, COMMAND_ALLOCATOR_FREE_ENCODERS, BUFFER_POOL }
    ...
    rank SURFACE_PRESENTATION "Surface::presentation" followed by { TEXTURE_CLEAR_MODE, DEVICE_SNATCHABLE_LOCK, DEVICE_COMMAND_INDICES, DEVICE_TRACKERS, SHARED_TRACKER_INDEX_ALLOCATOR_INNER }
