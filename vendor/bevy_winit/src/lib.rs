...
pub struct WinitPlugin {
    ...
    /// On macOS, avoid activating over another application at launch.
    /// Other platforms ignore this option. Default preserves winit activation.
...
impl Plugin for WinitPlugin {
    ...
    fn build(&self, app: &mut App) {
        ...
        #[cfg(target_os = "macos")]
        {
            ...
            event_loop_builder.with_activate_ignoring_other_apps(!self.prevent_activation);
        }
